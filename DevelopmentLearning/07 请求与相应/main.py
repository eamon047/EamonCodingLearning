...
app.mount("/static", StaticFiles(directory="/Users/eamon/EamonLearn/PersonalProject/07 请求与相应/statics"))
# 访问方法: http://127.0.0.1:8080/static/css/common.css
# 访问方法: http://127.0.0.1:8080/static/images/1.jpeg
